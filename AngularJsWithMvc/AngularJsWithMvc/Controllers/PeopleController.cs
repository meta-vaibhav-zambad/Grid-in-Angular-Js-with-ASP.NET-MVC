...
namespace AngularJsWithMvc.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,Company,Employed,Age")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,Company,Employed,Age")] Person person)
        {
            if (ModelState.IsValid)
            {
