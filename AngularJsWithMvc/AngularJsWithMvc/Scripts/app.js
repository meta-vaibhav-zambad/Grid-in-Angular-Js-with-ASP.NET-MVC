        ...
        onRegisterApi: function (gridApi) {
            ...
            $timeout(function () {
                ...
                $http.get("/Grids/GetGridColumnState").then(function (response) {
                    ...
                    if ($scope.defaultBehaviour[0].GroupBy != null && $scope.defaultBehaviour[0].GroupBy != undefined) {
                    ...
                    if ($scope.defaultBehaviour[0].SortBy != null && $scope.defaultBehaviour[0].Direction != null) {
